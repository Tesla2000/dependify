...
class TestInjected(TestCase):
    ...
    def test_injected_error_cases(self):
        ...
        self.assertIn("already provided as a positional argument", str(cm.exception))
    ...
    def test_injected_mixed_required_and_optional(self):
        ...
        obj2 = MixedClass(2, "Product", description="A product", tags=["new", "sale"])
    ...
    def test_injected_dependency_injection_with_defaults(self):
        ...
        self.assertIsInstance(service1.db, Database)  # Auto-injected despite default
